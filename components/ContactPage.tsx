                   ...
                   <div className="space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                           ...
                           <input type="text" required className={inputClass} placeholder="e.g. Aditi" />
                        </div>
                        <div>
                           <label className={labelClass}>Last Name</label>
                           <input type="text" required className={inputClass} placeholder="e.g. Rao" />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                          <div>
                             ...
                             <input type="email" required className={inputClass} placeholder="name@example.com" />
                          </div>
                          <div>
                      ...
                      <div>
                         ...
                         <textarea rows={5} required className={`${inputClass} resize-none`} placeholder="Tell us how we can help..."></textarea>
                      </div>

                      <button 
                        type="submit" 
                        className="w-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold py-4 rounded-xl hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-2"
                      >
                         Send Message
