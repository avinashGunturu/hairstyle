...
export const UserInfoForm: React.FC<UserInfoFormProps> = ({ initialData, onSubmit }) => {
  ...
  // Only update if explicitly provided (usually we want fresh start)
  useEffect(() => {
    if (initialData) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto animate-fade-in px-4 md:px-0">
      <div className="glass-panel rounded-3xl p-1 shadow-2xl shadow-brand-900/10 dark:shadow-black/40">
        <div className="bg-white/90 dark:bg-neutral-900/95 rounded-[20px] p-6 md:p-10 backdrop-blur-xl">
